...
/*****/
/*****/ var رقم = __arabi__translate__(
  Number,
  __flatted__parse__('[{"ليس_رقما":"1"},"isNaN"]'),
  __flatted__parse__('[{}]')
);
/*****/ var كائن = __arabi__translate__(
  Object,
  __flatted__parse__(
...
لوحة.اطبع('------ جافاسكريبت بالعربي ------ جملة حلقة "لكل"');
let أ = 0;
for (; أ !== 5; ) 0, ++أ;
const هذه_المصفوفة = ['أنا أسعى', 'لوضع لغتي  في مكانها الطبيعي'];
for (let م of هذه_المصفوفة) {
  لوحة.اطبع(م);
}
