...
let es6ModuleTranslationPath = path.resolve(
  __dirname,
  'مصدر/أكواد/أكواد-ترجمة-الوحدة.مخطوطة_إكما6.js'
);
let comModuleTranslationPath = path.resolve(
  __dirname,
  'مصدر/أكواد/أكواد-ترجمة-الوحدة.جس-الشائعة.js'
);
